...
public class VolunteersIndirectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_volunteers_indirect);
    ...
    public void goEditVol(View view) {
        Intent go_edit = new Intent(this, VolunteersEditActivity.class);
